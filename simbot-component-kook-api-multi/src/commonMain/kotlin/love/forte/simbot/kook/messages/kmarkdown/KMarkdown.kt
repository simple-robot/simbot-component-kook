...
/**
 * @suppress DSL Mark annotation for KookMarkdownBuilder
 */
...
/**
 * @suppress DSL Mark annotation for KookMarkdownBuilderTop
 */
@Target(AnnotationTarget.FUNCTION, AnnotationTarget.PROPERTY)
@DslMarker
...
public interface KMarkdown {
     ...
     * 提及部分
     *
     * 参考 [KMarkdown消息](https://developer.kookapp.cn/doc/event/message#KMarkdown%20%E6%B6%88%E6%81%AF)
     */
...
public data class RawValueKMarkdown(
    ...
    override val mentionRolePart: List<SimpleRole> = emptyList(),
) : KMarkdown {
    public companion object {
...
public class KMarkdownBuilder(public val appender: Appendable = StringBuilder()) {
     ...
     */
    @KookMarkdownBuilderDsl
    public fun serverEmoticons(name: CharSequence, id: String): KMarkdownBuilder =
...
public interface KookMarkdownGrammar<P> {
    ...
    public object ServerEmoticons : BaseKaiheilaCustomKookMarkdownGrammar<MdServerEmoticons>() {
        ...
        public fun appendTo(name: CharSequence, id: String, appendable: Appendable) {
