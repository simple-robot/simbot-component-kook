...
public enum class PermissionType(public val bitValue: UInt) {
    /**
     ...
     * 权限的实际值
     */
    public val value: UInt get() = 1u shl bitValue.toInt()
    ...
    public companion object {
        ...
        @JvmStatic
        @JvmName("combine")
        public fun _combine(vararg perm: PermissionType): Int = combine(*perm).toInt()
    }
}
