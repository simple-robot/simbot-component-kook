...
import love.forte.simbot.component.kaihieila.event.KaiheilaUserUpdatedEvent
 ...
 */
internal data class KaiheilaUserUpdatedEventImpl(
    override val bot: KaiheilaComponentBot,
    override val sourceEvent: KhlEvent<Sys<UserUpdatedEventBody>>
) : KaiheilaUserUpdatedEvent()